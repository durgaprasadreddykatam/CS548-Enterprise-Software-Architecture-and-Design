    ...
    private void addTreatmentImpl(TreatmentDto dto, Consumer<Treatment> parentFollowUps)
        ...
        try {
            ...
            if (dto instanceof DrugTreatmentDto) {
                ...
                followUpsConsumer=provider.importPhysiotherapy(dto.getId(),patient,provider,dto.getDiagnosis(),physiotherapyTreatmentDto.getTreatmentDates(),parentFollowUps);
