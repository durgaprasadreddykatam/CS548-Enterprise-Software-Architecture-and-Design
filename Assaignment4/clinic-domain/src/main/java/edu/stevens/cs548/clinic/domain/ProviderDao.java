...
public class ProviderDao implements IProviderDao {
	...
	public Provider getProvider(UUID id, boolean includeTreatments) throws ProviderExn {
		 ...
		 */
		String queryName = includeTreatments ? "SearchProviderWithTreatmentsByProviderId" : "SearchProviderByProviderId";
	...
	public List<Provider> getProviders() {
		/*
		 * Return a list of all providers (remember to set treatmentDAO)
		 *
